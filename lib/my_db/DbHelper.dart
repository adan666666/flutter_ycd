...
class DbHelper {
  ...
  Future<Database> _initDb() async {
    ...
    await openDatabase(path, version: 1, onCreate: (db, version) {
      ...
      db.execute("create table $table2 (column_xiazhujine text not null, colmun_shuyingzhi text not null,colmun_shuyingzhi_d text,colmun_shengfulu text,colmun_zx text,colmun_remark text,column_current_jin text)");
